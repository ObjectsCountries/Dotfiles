...
On Linux, these files should be dropped in ~/.config/unity3d/Steel Crate Games/Keep Talking and Nobody Explodes/. Remember to replace "kasra" with your username.
